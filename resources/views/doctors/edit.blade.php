...
@section('content')
    ...
    <div class="card">
    	...
    	<form method="post" action="{{ route('doctors.update', $doctor->id) }}" enctype="multipart/form-data" id="doctors_create_form">
    		@csrf()
	    		...
	    		<div class="row">
	    			<div class="col-md-4 col-sm-12" style="margin: auto;">
                        ...
                        @if(!empty($doctor->image))
                            <img src="{{ $doctor->image }}" alt="..." id="output" class="img-thumbnail rounded mx-auto d-block mb-3"  onerror="this.src='{{ asset('assets/images/user.png') }}';">
                        @else
				          	...
				          	<div class="row">
								<div class="col-md-8">		
									...
									<div class="form-group">
										...
										<input type="text" name="name" id="name" value="{{ $doctor->name }}" class="form-control @error('name') form-control-error @enderror" required="required">
									...
									<div class="form-group">
										...
										<input type="email" name="email" id="email" class="form-control @error('email') form-control-error @enderror" required="required" value="{{$doctor->email}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea cols="30" rows="10" name="description" class="form-control @error('description') form-control-error @enderror" id="description">{{$doctor->description}}</textarea>
										@error('description')
											<span class="text-danger">{{ $message }}</span>
										@enderror
									</div>     
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" id="role" class="form-control @error('role') form-control-error @enderror">
                                            <option value="{{$doctor->role}}">{{$doctor->role}}</option>
