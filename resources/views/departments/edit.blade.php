				          	...
				          	<div class="row">
								<div class="col-md-8">		
									...
									<div class="form-group">
										...
										<input type="text" name="name" id="name" class="form-control @error('name') form-control-error @enderror" required="required" value="{{$department->name}}">
                                    ...
                                    <div class="form-group">
										<label for="code" class="required">{{__('department.form.code')}}:</label>

										<input type="text" name="code" id="code" class="form-control @error('code') form-control-error @enderror" required="required" value="{{$department->code}}">
                                    ...
                                    <div class="form-group">
										<label for="description" class="required">{{__("department.form.description")}}:</label>

                                        <textarea cols="30" rows="10" name="description" class="form-control @error('description') form-control-error @enderror" id="description">{{$department->description}}</textarea>
										@error('description')
											<span class="text-danger">{{ $message }}</span>
										@enderror
									</div>     
