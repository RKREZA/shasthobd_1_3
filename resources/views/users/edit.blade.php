    	...
    	<form method="post" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data" id="user_edit_form">
	    	...
	    	<div class="card-header">
	    		<div class="row">
			    	<div class="col-6">
			    		<h2 class="card-title">
					        <a href="{{ route('users.index') }}"><i data-feather="arrow-left" class="feather-icon"></i></a> {{__('user.edit.title')}}
					    </h2>
			    	</div>
			    	<div class="col-6">
	    				...
	    				<div class="row">
							...
							<div class="col-md-4 col-sm-12" style="margin: auto;">
						            ...
						            <div class="input-group mb-5">
						            	@if(!empty($user->image))
						            		<img src="{{ $user->image }}" alt="..." id="output" class="img-thumbnail rounded mx-auto d-block mb-3"  onerror="this.src='{{ asset('assets/images/user.png') }}';">
						            	@else
